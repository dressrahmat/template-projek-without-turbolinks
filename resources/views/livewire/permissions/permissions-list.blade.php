                    ...
                    <td>
                        ...
                        <div class="dropdown">
                            ...
                            <ul tabindex="0"
                                ...
                                <li class="my-1">
                                    <button class="btn btn-xs rounded-md btn-secondary" wire:key="{{ $permission->id }}" wire:click="delete({{ $permission->id }})" wire:confirm="Apakah Anda yakin ingin menghapus {{ $permission->name }}?">
