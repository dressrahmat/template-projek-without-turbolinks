<div class="mb-2">
    <form wire:submit.prevent="save" enctype="multipart/form-data" class="grid grid-cols-2 gap-4">
        <div class="card card-side bg-base-100 shadow-xl">
            <div class="card-body">
                ...
                <div class="grid grid-cols-2 gap-x-2">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <input type="text" wire:model="form.nama_depan" placeholder="Masukkan nama depan"
                                ...
                                autofocus />
                            @error('form.nama_depan') <span class="error text-red-500">{{ $message }}</span> @enderror
                        </label>
                    </div>
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            @error('form.nama_belakang') <span class="error text-red-500">{{ $message }}</span>
                            @enderror
                        </label>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-x-2">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            @error('form.tanggal_lahir') <span class="error text-red-500">{{ $message }}</span>
                            @enderror
                        </label>
                    </div>
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            @error('form.nomor_telepon') <span class="error text-red-500">{{ $message }}</span>
                            @enderror
                        </label>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-x-2">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            <span class="label-text mb-2">Status Pernikahan</span>
                            <select wire:model="form.status_pernikahan" name="status_pernikahan" id="status_pernikahan"
                                class="select select-bordered rounded-lg bg-gray-100 text-gray-900 select-accent @error('form.status_pernikahan') border-red-500 @enderror">
                                <option value="">Pilih Status Pernikahan</option>
                                <option value="lajang">Lajang</option>
                                <option value="menikah">Menikah</option>
                                <option value="cerai">Cerai</option>
                            </select>
                            @error('form.status_pernikahan') <span class="error text-red-500">{{ $message }}</span>
                            @enderror
                        </label>
                    </div>
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            <span class="label-text mb-2">Pendidikan Terakhir</span>
                            <input type="text" wire:model="form.pendidikan_terakhir"
                                placeholder="Masukkan pendidikan terakhir"
                                class="input input-bordered rounded-lg bg-gray-100 text-gray-900 input-accent @error('form.pendidikan_terakhir') border-red-500 @enderror" />
                            @error('form.pendidikan_terakhir') <span class="error text-red-500">{{ $message }}</span>
                            @enderror
                        </label>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-x-2">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            @error('form.jenis_kelamin') <span class="error text-red-500">{{ $message }}</span>
                            @enderror
                        </label>
                    </div>
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            @error('form.agama') <span class="error text-red-500">{{ $message }}</span> @enderror
                        </label>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-x-2">
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            <select wire:model="form.provinsi"
                            ...
                            @error('form.provinsi') <span class="error text-red-500">{{ $message }}</span> @enderror
                        </label>
                    </div>
                    ...
                    <div class="mb-2">
                        <label class="form-control">
                            ...
                            @error('form.kota') <span class="error text-red-500">{{ $message }}</span> @enderror
                        </label>
                    </div>
                </div>
                ...
                <div class="mb-2">
                    <label class="form-control">
                        ...
                        @error('form.alamat') <span class="error text-red-500">{{ $message }}</span> @enderror
                    </label>
                </div>
        ...
        <div class="card card-side h-fit bg-base-100 shadow-xl">
            <div class="card-body">
                <!-- Upload photo_profile -->
                <div class="mb-2">
                    <label class="form-control">
                        <span class="label-text mb-2">Upload photo_profile</span>
                ...
                <div class="mb-2">
                    <label class="form-control">
                        ...
                        <textarea wire:model="form.bio" placeholder="Masukkan bio"
                            class="textarea textarea-bordered rounded-lg bg-gray-100 text-gray-900 textarea-accent @error('form.bio') border-red-500 @enderror"></textarea>
                        @error('form.bio') <span class="error text-red-500">{{ $message }}</span> @enderror
                    </label>
                </div>
                ...
                <div class="mb-2">
                    <label class="form-control">
                        <span class="label-text mb-2">Amanah</span>
                        <input type="text" rows="4" wire:model="form.amanah" placeholder="Masukkan amanah"
                            class="input input-bordered rounded-lg bg-gray-100 text-gray-900 input-accent @error('form.amanah') border-red-500 @enderror" />
                        @error('form.amanah') <span class="error text-red-500">{{ $message }}</span> @enderror
                    </label>
                </div>
